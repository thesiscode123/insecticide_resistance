...
def manage_serialization(cb, serialize, pull_from_serialization, years, burnin='958bfb3d-caec-ec11-a9f9-b88303911bc1') :
    ...
    if pull_from_serialization :
        ...
        cb.update_params({
            'Serialized_Population_Path': os.path.join(output_paths[0], 'output'),
                ...
                "Resistances": [
                    {
                        ...
                        "Blocking_Modifier": 1.0,
                        "Killing_Modifier": 0.05,  # killing modifier lower
                        "Larval_Killing_Modifier": 0.1,
                        "Repelling_Modifier": 0.1,
                        "Species": "gambiae"
                    }
                ]
            }
...
if __name__ == "__main__":
    ...
    exp_name = 'Node Checkerboard ITNs'
    numseeds = 3
    years = 10
    serialize = False
    ...
    if not serialize :
        builder = ModBuilder.from_list([[ModFn(DTKConfigBuilder.set_param, 'Run_Number', seed),
                                         ModFn(configure_node_checkerboard, scenario=scenario,
                                               start_day=0, coverage=0.8)
                                         ]
